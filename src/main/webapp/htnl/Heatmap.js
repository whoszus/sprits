...
//defaultGradient: { 0.45: "rgb(2,227,0)", 0.55: "rgb(255,255,0)", 0.75: "rgb(255,125,1)",0.85: "rgb(254,0,0)", 0.95: "rgb(152,0,75)",1.0: "rgb(128,0,35)"},
defaultGradient: {  1.0: "rgb(255,0,0)"},  //空气质量良好，绿色
defaultGradient2: {  1.0: "rgb(255,255,0)"},    //空气质量中等，黄色
defaultGradient3: {  1.0: "rgb(255,125,1)"},    //空气质量对敏感人不健康，橙色
defaultGradient4: {  1.0: "rgb(254,0,0)"},    //空气质量不健康，红色
defaultGradient5: {  1.0: "rgb(152,0,75)"},    //空气质量非常不健康，紫色
defaultGradient6: {  1.0: "rgb(128,0,35)"},    //空气质量有毒害，褐红色
  defaultMaxOpacity: 1,
  defaultMinOpacity: 0,
  defaultBlur: .85,
  defaultXField: 'x',
...
//	if(0<=aqi && aqi<=50){
//		var gradientConfig = config.gradient || config.defaultGradient1;
//	}else if(51<=aqi && aqi<=100){
//		var gradientConfig = config.gradient || config.defaultGradient2;
//	}else if(101<=aqi && aqi<=150){
//		var gradientConfig = config.gradient || config.defaultGradient3;
//	}else if(151<=aqi && aqi<=200){
//		var gradientConfig = config.gradient || config.defaultGradient4;
//	}else if(201<=aqi && aqi<=300){
//		var gradientConfig = config.gradient || config.defaultGradient5;
//	}else {
//		var gradientConfig = config.gradient || config.defaultGradient6;
//	}
    ...
    var gradient = paletteCtx.createLinearGradient(0, 0, 256, 1);  //(0, 0, 256, 1)
...
//    tplCtx.fillStyle = 'rgba(0,0,0,1)';
      ...
      tplCtx.fill();
    	...
    	//创建线性的渐变对象(渐变开始x坐标，开始y坐标，结束X，结束Y)
...
//     fillStyle 属性来设置用于填充绘图的颜色、渐变或模式。
	 ...
	 //width:矩形的宽度，以像素计;height	矩形的高度，以像素计
...
var Heatmap = (function HeatmapClosure() {
  ...
  var _connect = function(scope) {
  	var aa;
	if(0<=aqi && aqi<=50){
		aa = scope._config['gradient'] || scope._config['defaultGradient1']
	}else if(51<=aqi && aqi<=100){
		aa = scope._config['gradient'] || scope._config['defaultGradient2']
	}else if(101<=aqi && aqi<=150){
		aa = scope._config['gradient'] || scope._config['defaultGradient3']
	}else if(151<=aqi && aqi<=200){
		aa = scope._config['gradient'] || scope._config['defaultGradient4']
	}else if(201<=aqi && aqi<=300){
		aa = scope._config['gradient'] || scope._config['defaultGradient5']
	}else{
		aa = scope._config['gradient'] || scope._config['defaultGradient6']
	}
aa = scope._config['gradient'] || scope._config['defaultGradient']
